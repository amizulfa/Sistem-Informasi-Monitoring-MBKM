    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h4> Data Mahasiswa MBKM Program Indonesian Internasional Student Mobility Awards (IISMA)</h2>
            </div>
            <div class="card-body">
                
                <form action="iisma.php" method="post">
                ...
                <?php 
                    ...
                    join program_KM on join_program.id_program=program_KM.id_program WHERE program_KM.id_program='2'";
